; ModuleID = '../files/test/00219.c'
source_filename = "../files/test/00219.c"
...
define dso_local i32 @main() #0 {
  ...
  %33 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0))
  store i32 1, i32* %2, align 4
